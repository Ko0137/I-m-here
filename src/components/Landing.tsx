  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col relative overflow-hidden">
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 text-center max-w-5xl mx-auto">
        ...
        <button 
          onClick={onLogin}
          className="px-8 py-4 bg-rose-600 hover:bg-rose-500 text-white rounded-xl font-bold text-lg shadow-xl shadow-rose-900/20 transition-all hover:scale-105 active:scale-95 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200"
        >
          Войти через Google
        </button>
